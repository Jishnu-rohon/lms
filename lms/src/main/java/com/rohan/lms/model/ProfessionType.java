...
public class ProfessionType {
	...
	public String toString() {
		return "ProfessionType [slno=" + slno + ", profession=" + profession + ", approveStat=" + approveStat
				+ ", createdDate=" + createdDate + ", dtAction=" + dtAction + ", isDeleted=" + isDeleted + "]";
	}

	public ProfessionType(int slno, String profession, int approveStat, Date createdDate, Date dtAction,
			int isDeleted) {
		super();
		this.slno = slno;
		this.profession = profession;
